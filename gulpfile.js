...
gulp.task('build-version', gulp.series('bump-prerelease', 'partials', gulp.parallel('inject', 'other'), 'build', 'injectInfo', 'createzip'));
gulp.task('build', gulp.series('partials', gulp.parallel('inject', 'other'), 'build', 'injectInfo', 'createzip'));
